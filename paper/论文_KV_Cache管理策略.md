...
**代码可用性。** 为便于课程评阅和复现实验，本文使用的仿真脚本、合成访问迹生成器和绘图代码已公开于 GitHub：`https://github.com/123xpw/kv-cache-learned-eviction`。该仓库包含 `kv_cache_sim.py`、依赖说明、主要实验图表和论文 Markdown 草稿。需要说明的是，公开代码仅对应本文的离线 Trace-driven 仿真，不包含真实 LLM 推理框架集成。
